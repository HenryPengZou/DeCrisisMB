...
def oneRun(log_dir_path_multiRun=None, **params):
    ...
    output_dir_path = './'
    output_dir_path = './experiment/OOD_result/1_h2t'

    # set data path
    base_path = './data'
    target_list = ['hurricane']
    target_test_list = ['threecrises']
    ...
    if aug_mode:
        if strong_aug_mode:
            bt_data_path = '/data/HumAID_balance/hurricane/bt_data.csv'   # back-translated data path
