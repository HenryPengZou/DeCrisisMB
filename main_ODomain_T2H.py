...
def oneRun(log_dir_path_multiRun=None, **params):
    ...
    output_dir_path = './experiment/OOD_result/2_t2h'

    # set data path
    base_path = './data'
    target_list = ['threecrises']
    target_test_list = ['hurricane']
    ...
    target_test_df = read_data_split(target_test_list, 'test')
    ...
    if aug_mode:
        if strong_aug_mode:
            bt_data_path = '/home/pzou3/1_ResearchProjects/1_imbalancedSF/data/HumAID_balance/hurricane/bt_data.csv'   # back-translated data path
